...
# Hyperparameters 256 128  16 300 100 3 35 50k 0.15 0.1 0.02 1e-4 2 
tf.app.flags.DEFINE_integer('hidden_dim', 20, 'dimension of RNN hidden states')
tf.app.flags.DEFINE_integer('emb_dim', 12, 'dimension of word embeddings')
